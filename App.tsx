...
import PackingList from './components/PackingList'; // New Import
import UsefulLinks from './components/UsefulLinks'; // New Import
...
const App: React.FC = () => {
  ...
  const [packedItems, setPackedItems] = useState<Record<string, boolean>>({}); // Packing List State
